# ARC 7 slurm rocky9 test-site
This repository holds the arc.conf and slurm configuration files for the ARC SLURM test-site. 

The endpoint fqdn is: **arctestcluster-slurm-rocky9-arc7-ce1.cern-test.uiocloud.no**
...
View arc.conf via curl or web-broser with: [http://arctestcluster-slurm-rocky9-arc7-ce1.cern-test.uiocloud.no/arcconf](http://arctestcluster-slurm-rocky9-arc7-ce1.cern-test.uiocloud.no/arcconf)

## Read ARC log files
Browse ARC log files via curl or web-browser with: [http://arctestcluster-slurm-rocky9-arc7-ce1.cern-test.uiocloud.no/arclogs](http://arctestcluster-slurm-rocky9-arc7-ce1.cern-test.uiocloud.no/arclogs)


## Check ARC state
View ARC state via curl or web-browser with: [http://arctestcluster-slurm-rocky9-arc7-ce1.cern-test.uiocloud.no/arcstatus](http://arctestcluster-slurm-rocky9-arc7-ce1.cern-test.uiocloud.no/arcstatus)
...
```
git clone https://source.coderefinery.org/nordugrid/arctestsite-slurm-rocky9-arc7.git
``` 

B) GitHub mirror site:

```
git clone https://github.com/nordugrid/arctestsite-slurm-rocky9-arc7.git
``` 
...
```
cd arctestsite-slurm-rocky9-arc7
